...
namespace SubtitlesParserV2
{
	...
	public class SubtitleFormat
	{
		...
		public static readonly IReadOnlyDictionary<SubtitleFormatType, SubtitleFormat> Formats = new Dictionary<SubtitleFormatType, SubtitleFormat>()
		{
			...
			{ SubtitleFormatType.TMPlayer, new SubtitleFormat("TMPlayer", new string[] {"tmp"}, new TmpParser()) },
			...
			{ SubtitleFormatType.TTML, new SubtitleFormat("Timed Text Markup Language", new string[] {"ttml", "dfxp", "xml", "itt"}, new TtmlParser()) },
